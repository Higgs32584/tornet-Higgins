...
def main():
    ...
    parser.add_argument("--output_csv", type=str, help="Optional: output CSV path for precision-recall data")
    ...
    df = pd.DataFrame({
        "threshold": np.append(thresholds, 1.0),  # Ensure matching shape with precision/recall
        "precision": precision,
        "recall": recall
    })
