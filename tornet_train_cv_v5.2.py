...
def build_model(model='wide_resnet',shape:Tuple[int]=(120,240,2),
    ...
    attention_map = Dropout(rate=0.1, name='attention_dropout')(attention_map)
    ...
    x_dense = Dropout(rate=0.3, name='dropout_final')(x_dense)
...
"added one specific change here, placed activation AFTER add, placed dropout in the middle of wide resnet, removed MaxPool2D"
