...
def dense_layer(x, growth_rate):
    """A single dense layer with BatchNorm, ReLU, and Conv."""
...
def dense_block(x, num_layers, growth_rate):
    """DenseNet block with multiple dense layers."""
...
def build_model(
    ...
    x = dense_block(x, num_layers=1, growth_rate=24)
    x = se_block(x)
