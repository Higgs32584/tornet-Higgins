...
DEFAULT_CONFIG={"epochs":100, 
                ...
                "decay_steps": 5000, 
                "decay_rate": 0.98, 
                "l2_reg": 0.001, "wN": 1.0, "w0": 1.0, "w1": 1.0, "w2": 2.0, "wW": 0.5, "label_smooth": 0.1, "loss": "cce", "head": "maxpool", "exp_name": "tornado_baseline", "exp_dir": ".", "dataloader": "tensorflow-tfds", "dataloader_kwargs": {"select_keys": ["DBZ", "VEL", "KDP", "RHOHV", "ZDR", "WIDTH", "range_folded_mask", "coordinates"]}}
