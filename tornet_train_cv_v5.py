...
def main(config):
    try:
        ...
        loss = keras.losses.BinaryCrossentropy(
            from_logits=from_logits, label_smoothing=0.1
        )
        ...
        K.clear_session()  # Prevent memory leaks after training
        del ds_train, ds_val, nn, history, sample_batch  # Explicit cleanup
