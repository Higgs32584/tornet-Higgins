...
DEFAULT_CONFIG={"epochs":100, 
                ...
                "val_years": [2021, 2022], "batch_size": 128, "model": "vgg_gated", 
                "start_filters": 48, 
                "learning_rate": 1e-3, 
                "decay_steps": 1386, 
                "decay_rate": 0.958, 
                "l2_reg": 0.001, "wN": 1.0, "w0": 2.0, "w1": 2.0, "w2": 2.0, "wW": 2.0, "label_smooth": 0.1, "loss": "cce", "head": "maxpool", "exp_name": "tornado_baseline", "exp_dir": ".", "dataloader": "tensorflow-tfds", "dataloader_kwargs": {"select_keys": ["DBZ", "VEL", "KDP", "RHOHV", "ZDR", "WIDTH", "range_folded_mask", "coordinates"]}}
